...
┏『 *\`㊕ ᴏ ᴡ ɴ ᴇ ʀ - ᴏ ɴ ʟ ʏ ㊕\`* 』━⊱
┣ᐉ *${prefix}mode public*
┣ᐉ *${prefix}mode private*
┣ᐉ *${prefix}autostatus on/off* (works on only public mode) 
┣ᐉ *${prefix}ban*
┣ᐉ *${prefix}unban*
┣ᐉ *${prefix}banlist*
┣ᐉ *${prefix}save*
...
┣ᐉ *${prefix}unmute*
┣ᐉ *${prefix}mute*
┣ᐉ *${prefix}antilink*  (works on only public mode)
┣ᐉ *${prefix}linkgc*
┣ᐉ *${prefix}invite*
┣ᐉ *${prefix}disappear*
┣ᐉ *${prefix}del*
